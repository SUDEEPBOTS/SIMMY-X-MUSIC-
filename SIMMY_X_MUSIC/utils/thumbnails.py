...
async def get_thumb(videoid):
    ...
    try:
        ...
        arial = ImageFont.truetype("SIMMY_X_MUSIC/assets/font2.ttf", 30)
        font = ImageFont.truetype("SIMMY_X_MUSIC/assets/font.ttf", 30)
        bold_font = ImageFont.truetype("SIMMY_X_MUSIC/assets/font.ttf", 33)
