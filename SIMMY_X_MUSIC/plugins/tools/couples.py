...
#BOT FILE NAME
from SIMMY_X_MUSIC import app as app
from SIMMY_X_MUSIC.mongo.couples_db import _get_image, get_couple
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "SIMMY_X_MUSIC/assets/upic.png"
         try:
         ...
         img = Image.open("SIMMY_X_MUSIC/assets/cppic.png")
